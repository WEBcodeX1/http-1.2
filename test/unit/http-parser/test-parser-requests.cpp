...
BOOST_AUTO_TEST_CASE( test_single_valid_get_request_1byte_segment_transmit )
{
    cout << "Check single GET request (1-byte segment transmit)." << endl;
...
BOOST_AUTO_TEST_CASE( test_single_post_request_1byte_segment_transmit )
{
    cout << "Check single POST request (1-byte segment transmit)." << endl;
...
BOOST_AUTO_TEST_CASE( test_multiple_valid_get_request_1byte_segment_transmit )
{
    cout << "Check multiple GET requests (1-byte segment transmit)." << endl;
...
BOOST_AUTO_TEST_CASE( test_multiple_valid_get_and_post_requests_1byte_segment_transmit )
{
    cout << "Check multiple GET and POST requests (1-byte segment transmit)." << endl;
...
BOOST_AUTO_TEST_CASE( test_single_valid_post_request_partial_1byte_segment_transmit )
{
    cout << "Check single POST request (partial, 1-byte segment transmit)." << endl;
